                        ...
                        <header class="content-header">
                            ...
                            <div class="info">
                                ...
                                <p>
                                    ...
                                    <span>
                                        <?= get_the_date('d/m/Y') ?> às <?= get_the_time() ?>
                                    </span>
                                </p>

                                <p>
                                    <i class="ph ph-clock"></i>
                                    <span><?php rtwp_the_reading_time(post_content: get_the_content()); ?></span>
                                </p>
...
<?php // echo '<pre>'; ?>
<?php // rtc_the_reading_time(post_content: get_the_content()); ?>
<?php // echo '<br>'; ?>
<?php // rtc_the_reading_time(); ?>
<?php // echo '<br>'; ?>
<?php // rtc_the_reading_time(post_id: 897); ?>
<?php // echo '<br>'; ?>
<?php // rtc_the_reading_time(post_id: 889); ?>
<?php // echo '<br>'; ?>
<?php // rtc_the_reading_time(post_id: 748); ?>
<?php // echo '</pre>'; ?>
